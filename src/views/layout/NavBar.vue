<template>
        ...
        <div class="flex justify-between items-center px-9">
          ...
          <!-- {{ store.state.user.permissions }} -->
            ...
            <div class="flex items-center">
                ...
                <button class="mr-2">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-5 h-5 stroke-blue-600">
    ...
    <div id="sideNav" 
        :class="[
            isSideNavHidden ? 'lg:block bg-white w-64 h-screen fixed rounded-none border-none'
            : 'hidden'
        ]">
...
const toggleSideNav = () => {
  isSideNavHidden.value = !isSideNavHidden.value;
};
